...
CMWT_VALIDATE SearchField, "Search Field Name was not specified"
CMWT_VALIDATE SearchValue, "Search Value was not specified"
CMWT_VALIDATE SearchMode, "Search Mode was not provided"
...
<table class="tfx">
	<tr>
		<td class="td6 bgDarkGray">
			<p>QUERY: Where [<%=SearchField%>] [<%=SearchMode%>] [<%=SearchValue%>] / SORT BY: [<%=SortBy%>]</p>
		</td>
		<td class="td6 right">
			<input type="button" name="b3" id="b3" class="btx w140 h30" value="Edit Report" onClick="document.location.href='reportedit.asp?id=<%=ReportID%>'" />
		</td>
	</tr>
</table>
<%
